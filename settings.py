...
URL_PATH_PREFIX = env('URL_PATH_PREFIX', '/sti/cmdb/')
...
DATABASES = {
    'default': {
        ...
        'NAME': env('POSTGRES_DB', 'sti_cmdb_db'),
        'USER': env('POSTGRES_USER', 'sti_cmdb_user'),
        'PASSWORD': env('POSTGRES_PASSWORD', 'sti_cmdb_pass'),
    }
}
...
# Session
SESSION_KEY = env("DJANGO_SESSION_KEY", 'sti-cmdb')
...
AUTHENTICATION_BACKENDS = ('suap_backend.backends.SuapOAuth2',)
...
LOGIN_REDIRECT_URL = env('DJANGO_LOGIN_REDIRECT_URL', URL_PATH_PREFIX + 'admin/')
